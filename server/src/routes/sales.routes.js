...
import { getAllInvoiceOrders, getAllOrders, getInvoiceAttachedFile, getInvoiceOrdersByClientId, getNextInvoiceIdAndCheckSeniority, getOrderAttachedFile, getProducts, getPurchaseOrdersByClientId, getPurchaseOrdersWithReadFalse, saveInvoice, saveSaleOrder, sendOrderReadyEmail, updateReadClientToFalseById } from "../controller/sales.controller.js";
